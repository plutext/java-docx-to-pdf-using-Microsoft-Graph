...
public class ConvertDocxBytesToPdfTest {
	...
	public void testConversionSdk() throws IOException, ConversionException {
		...
		byte[] docxBytes = FileUtils.readFileToByteArray(inFile);
...
//		DocxToPdfConverter converter = new PdfConverterLarge(new AuthConfigImpl(), httpClient);
	...
	@Test
	public void testConversionScribeOkHttpHttp() throws IOException, ConversionException {
